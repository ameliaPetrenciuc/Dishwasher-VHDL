...
HD_PWD='C:/Users/Petrenciuc Amelia/OneDrive/Desktop/VERSIUNE_NOUA_MASINA/masina_spalat_vase/masina_spalat_vase.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SETARE_PROGRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SETARE_PROGRAM.tcl
