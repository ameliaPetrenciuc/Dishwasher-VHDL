...
HD_PWD='C:/Users/Petrenciuc Amelia/OneDrive/Desktop/VERSIUNE_NOUA_MASINA/masina_spalat_vase/masina_spalat_vase.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log SETARE_PROGRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SETARE_PROGRAM.tcl -notrace
